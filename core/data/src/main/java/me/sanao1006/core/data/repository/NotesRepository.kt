...
interface NotesRepository {
    ...
    suspend fun createNotes(
        @Body notesCreateRequestBody: me.sanao1006.core.model.notes.NotesCreateRequestBody
    ): JsonObject

    @POST("api/notes/timeline")
    fun flowNotesTimeline(
        @Body notesTimeLineRequestBody: NotesTimeLineRequestBody
    ): Flow<List<me.sanao1006.core.model.notes.NotesTimeline>>

    @POST("api/notes/local-timeline")
    suspend fun getNotesLocalTimeline(
        @Body notesTimeLineRequestBody: NotesTimeLineRequestBody
    ): List<me.sanao1006.core.model.notes.NotesTimeline>
